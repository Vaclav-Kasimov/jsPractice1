(function (global) {
	...
	ajaxUtils.sendGetRequest =
		function(requestUrl, responseHandler){ //responseHandler Это обработчик ОТВЕТА на запрос, та функция, в которую и придет ответ на наш запрос и которая уже будет с ним что-то делать
